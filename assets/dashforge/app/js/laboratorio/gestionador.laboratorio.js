 ...
 function table() {
     ...
     var table = $('#table').DataTable({
             ...
             columns: [{
                 ...
                 title: "<input id='selectall' class='mg-r-10' type='checkbox' title='Descargar Todo'>",
             }, {
                 title: "Fecha:"
             }, {
             ...
             "drawCallback": function(settings) {
                 ...
                 $('.ver-resultado').click(function(e) {
                     ...
                     var fecha = currentRow.find("td:eq(2)").text();
     ...
     $('#_dt_search_text').on('keyup change', function() {
